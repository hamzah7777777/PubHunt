...
import cloud1 from './Mario Assets/Cloud1.png';
import cloud2 from './Mario Assets/Cloud2.png';
import hill1 from './Mario Assets/Hill1.png';
import hill2 from './Mario Assets/Hill2.png';
import brick from './Mario Assets/Brick.png';
import mysteryBlock from './Mario Assets/MysteryBlock.png';
import groundBlock from './Mario Assets/GroundBlock.png';
import goomba from './Mario Assets/Goomba_Walk1.png';
import marioJump from './Mario Assets/Mario_Big_Jump.png';
import magicMushroom from './Mario Assets/MagicMushroom.png';
import pipeTop from './Mario Assets/PipeTop.png';
import pipeBottom from './Mario Assets/PipeBottom.png';
import coin from './Mario Assets/Coin.png';
  ...
  return (
    ...
    <div style={{ minHeight: '100%', fontFamily: "'Press Start 2P', monospace", background: '#5c94fc' }}>
      ...
      <div style={{ position: 'relative', padding: '14px 0 0', minHeight: 240, overflow: 'hidden' }}>
        ...
        <div style={{
          position: 'relative', margin: '18px 10% 0', background: '#c84c0c', border: '2px solid #1a1a1a',
          ...
          <h1 style={{ margin: 0, fontFamily: "'Press Start 2P', monospace", fontSize: '0.9rem', lineHeight: 1.8, letterSpacing: '0.02em', color: '#f7dcb0', textShadow: '2px 2px 0 #1a1a1a' }}>
            {hint}
          </h1>
        </div>
      ...
      <div style={{ display: 'flex', gap: 12, margin: '16px 14px 0', flexWrap: 'wrap' }}>
        <div style={{ flex: '1 1 140px', background: '#00a800', border: '3px solid #000', padding: 12 }}>
          <strong style={{ fontSize: 10, display: 'block', marginBottom: 8, color: '#fff' }}>TIME</strong>
          <p style={{ margin: 0, fontFamily: "'VT323', monospace", fontSize: 18, color: '#fff' }}>{time}</p>
        </div>
      </div>
